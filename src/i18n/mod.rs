...
lang_map!(En, "English", [
    ...
    "cli.help.style"         => "QSO style: ragchew | contest | dx-pileup | darc-cw-contest | mwc-contest | cwt-contest | wwa-contest | wpx-contest | qtt-award | sst-contest | cq-dx | random",
...
lang_map!(De, "Deutsch", [
    ...
    "cli.help.style"         => "QSO-Stil: ragchew | contest | dx-pileup | darc-cw-contest | mwc-contest | cwt-contest | wwa-contest | wpx-contest | qtt-award | sst-contest | cq-dx | random",
...
lang_map!(Fr, "Français", [
    ...
    "cli.help.style"         => "Style du QSO : ragchew | contest | dx-pileup | darc-cw-contest | mwc-contest | cwt-contest | wwa-contest | wpx-contest | qtt-award | sst-contest | cq-dx | random",
...
lang_map!(It, "Italiano", [
    ...
    "cli.help.style"         => "Stile QSO: ragchew | contest | dx-pileup | darc-cw-contest | mwc-contest | cwt-contest | wwa-contest | wpx-contest | qtt-award | sst-contest | cq-dx | random",
