...
| ESP8266 | Serial MIDI (115200 baud) | VID `1a86` / PID `7523` <br>VID `2341` / PID `0001` (ATmega16U2, old bootloader)<br>VID `2341` / PID `0049` (WiFi Rev2)<br>VID `2341` / PID `0069` (R4 Minima)<br>VID `2341` / PID `0070` (R4 WiFi)<br>VID `1a86` / PID `7523` (CH340 clone)<br>VID `0403` / PID `6001` (FT232RL clone) | Linux, macOS, Windows |
